    ...
    return (
        <section className="grid gap-5">
            ...
            <div className="grid gap-3 rounded-lg border border-border bg-card p-4">
                <div className="grid gap-3 md:grid-cols-2 md:items-end xl:grid-cols-[minmax(16rem,1fr)_11rem_14rem]">
                    ...
                    <label className="grid gap-1 text-sm">
                        ...
                        <SelectMenu
                            ...
                            options={[
                                ...
                                { value: "rareTrophy", label: "Сначала редкие трофеи" },
                                { value: "trophy", label: "Сначала трофеи" },
                                { value: "incomePerHour", label: "По заработку в час" },
                            ]}
                        />
                    </label>
                </div>
